...
AgentIdentity agentIdentityFromJson(Map<String, Object?> json) => (
  agentName: switch (json['agent_name']) {
    final String v => v,
    _ => '',
  },
  registeredAt: switch (json['registered_at']) {
    final int v => v,
    _ => 0,
  },
...
Map<String, Object?> agentRegistrationToJson(
...
AgentRegistration agentRegistrationFromJson(Map<String, Object?> json) => (
  ...
  agentKey: switch (json['agent_key']) {
    final String v => v,
    _ => '',
  },
);
...
FileLock fileLockFromJson(Map<String, Object?> json) => (
  filePath: switch (json['file_path']) {
    final String v => v,
    _ => '',
  },
  agentName: switch (json['agent_name']) {
  ...
  acquiredAt: switch (json['acquired_at']) {
    final int v => v,
    _ => 0,
  },
...
LockResult lockResultFromJson(Map<String, Object?> json) => (
  acquired: switch (json['acquired']) {
    final bool v => v,
    _ => false,
  },
  lock: switch (json['lock']) {
    final Map<String, Object?> v => fileLockFromJson(v),
    _ => null,
  },
...
Message messageFromJson(Map<String, Object?> json) => (
  ...
  fromAgent: switch (json['from_agent']) {
    final String v => v,
    _ => '',
  },
  toAgent: switch (json['to_agent']) {
    final String v => v,
    _ => '',
  },
...
AgentPlan agentPlanFromJson(Map<String, Object?> json) => (
  ...
  currentTask: switch (json['current_task']) {
    final String v => v,
    _ => '',
  },
